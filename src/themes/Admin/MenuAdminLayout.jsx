...
import config from '../../route/configRoute'
...
MenuAdminLayout.propTypes = {}

function MenuAdminLayout() {
  ...
  const items = [
    ...
    getItem('Quản lí người dùng', 'adminUser', <UserOutlined />, [
      ...
      getItem(
        <Link to={config.routes.adminUserAdd}> Thêm người dùng</Link>,
        'adminUser2',
      ),
    ]),
    getItem('Quản lí đơn hàng', 'adminOrders', <FaMoneyCheckAlt />, [
      getItem(
        <Link to={config.routes.adminOrders}> Danh sách orders</Link>,
        'adminOrders1',
      ),
    ]),
    getItem('Quản lí Phòng chiếu', 'adminRooms', <GiTheater />, [
      ...
      getItem(
        <Link to={config.routes.adminRoomsCreate}> Thêm phòng chiếu</Link>,
        'adminRooms2',
      ),
    ]),
    getItem('Quản lí phim ', 'sub7', <BiCameraMovie />, [
      ...
      getItem(
        <Link to={config.routes.adminMoviecCreat}> Thêm phim</Link>,
        'adminMovie2',
      ),
    ]),
    getItem('Quản lí Đồ ăn', 'adminFood', <IoFastFoodOutline />, [
      getItem(
        <Link to={config.routes.adminFood}> Danh sách Food</Link>,
        'adminFood1',
      ),
      getItem(
        <Link to={config.routes.adminFoodCreate}> Thêm Food</Link>,
        'adminFood2',
      ),
    ]),
    ,
    getItem('Quản lí Slider', 'adminSlider', <BiSlider />, [
      getItem(
        <Link to={config.routes.adminSlider}> Danh sách Slider</Link>,
        'adminSlider1',
      ),
      getItem(
        <Link to={config.routes.adminSliderCreate}> Thêm Slider</Link>,
        'adminSlider2',
      ),
    ]),
    ...
    getItem('Quản lí Voucher', 'AdminVouchers', <FaTicketAlt />, [
      getItem(
        <Link to={config.routes.AdminVouchers}> Xem tất cả</Link>,
        'AdminVouchers1',
      ),
      getItem(
        <Link to={config.routes.AdminVouchersCreate}> Thêm voucher</Link>,
        'AdminVouchers2',
      ),
    ]),
    ...
    getItem('Quản lí bài viết', 'AdminPosts', <SnippetsOutlined />, [
      getItem(
        <Link to={config.routes.AdminPosts}> Xem tất cả</Link>,
        'AdminPosts1',
      ),
      getItem(
        <Link to={config.routes.AdminPosts}> Thêm bài viết</Link>,
        'AdminPosts2',
      ),
    ]),

    getItem(
      <Link to={config.routes.webConfig}>Cài đặt</Link>,
      'webConfig',
      <SettingOutlined />,
    ),
    getItem(
  ...
  return <Menu theme="dark" items={items} mode="inline" />
}
